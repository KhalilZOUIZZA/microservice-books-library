...
public class CopyRestAdmin {
    ...
    @Operation(summary = "find by book id")
    @GetMapping("book/id/{id}")
    public List<CopyDto> findByBookId(@PathVariable Long id){
        return findDtos(service.findByBookId(id));
    }
    @Operation(summary = "delete by book id")
    @DeleteMapping("book/id/{id}")
    public int deleteByBookId(@PathVariable Long id){
