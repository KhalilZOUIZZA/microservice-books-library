    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/admin/book/").permitAll()
                                .requestMatchers(HttpMethod.POST, "/api/client/book/find-paginated-by-criteria").permitAll() // Allow GET requests to this endpoint
