...
public class BookRestClientTest {
    ...
    @Mock
    private BookClientServiceImpl service;
    @Mock
    private BookConverter converter;

    @InjectMocks
    private BookRestClient controller;
