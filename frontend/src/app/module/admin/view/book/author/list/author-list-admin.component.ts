...
export class AuthorListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AuthorDto>();
    ...
    public async edit(dto: AuthorDto) {
    ...
    public async view(dto: AuthorDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AuthorDto) {
    ...
    public async duplicate(dto: AuthorDto) {
    ...
    public exportPdf(dto: AuthorDto): void {
...
// add
	...
	public initDuplicate(res: AuthorDto) {
	}
        ...
        return new Promise((resolve, reject) => {
            this.service.findByCriteria(this.criteria).subscribe(
                (allItems) => {
                    ...
                    resolve(); // Resolve the promise when data is prepared
                },
                (error) => {
    ...
    get selections(): Array<AuthorDto> {
        return this.service.selections;
    }

    set selections(value: Array<AuthorDto>) {
