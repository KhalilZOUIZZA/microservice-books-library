...
export class CategoryListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CategoryDto>();
    ...
    public async edit(dto: CategoryDto) {
    ...
    public async view(dto: CategoryDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CategoryDto) {
    ...
    public async duplicate(dto: CategoryDto) {
    ...
    public exportPdf(dto: CategoryDto): void {
...
// add
	...
	public initDuplicate(res: CategoryDto) {
	}
        ...
        return new Promise((resolve, reject) => {
            this.service.findByCriteria(this.criteria).subscribe(
                (allItems) => {
                    ...
                    resolve(); // Resolve the promise after the data preparation
                },
                (error) => {
    ...
    get selections(): Array<CategoryDto> {
        return this.service.selections;
    }

    set selections(value: Array<CategoryDto>) {
