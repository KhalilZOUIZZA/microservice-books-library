...
@Component({
    selector: 'app-copy-list-admin',
    templateUrl: './copy-list-admin.component.html'
})
export class CopyListAdminComponent implements OnInit {

    protected fileName = 'Copy';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CopyDto>();
    ...
    public async delete(dto: CopyDto) {
    ...
    public async duplicate(dto: CopyDto) {
    ...
    public exportPdf(dto: CopyDto): void {
    ...
    public initCol() {
        this.cols = [
            ...
            { field: 'book?.code', header: 'Book' },
        ];
    }


    public async loadBook() {
        this.bookService.findAllOptimized().subscribe(books => this.books = books, error => console.log(error))
    }


    public initDuplicate(res: CopyDto) {
    }
        ...
        return new Promise((resolve, reject) => {
            this.service.findByCriteria(this.criteria).subscribe(
                (allItems) => {
                    ...
                    this.criteriaData = [{
                        'Serial number': this.criteria.serialNumber ? this.criteria.serialNumber : environment.emptyForExport,
                    }];
                    resolve(); // Resolve when data preparation is done
                },
                (error) => {
    ...
    get selections(): Array<CopyDto> {
        return this.service.selections;
    }

    set selections(value: Array<CopyDto>) {
