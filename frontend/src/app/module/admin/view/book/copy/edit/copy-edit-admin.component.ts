...
@Component({
  selector: 'app-copy-edit-admin',
  templateUrl: './copy-edit-admin.component.html'
})
export class CopyEditAdminComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreateBook(book: string) {
        const isPermistted = await this.roleService.isPermitted('Book', 'edit');
        if (isPermistted) {
