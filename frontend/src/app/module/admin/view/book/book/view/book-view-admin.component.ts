...
@Component({
  selector: 'app-book-view-admin',
  templateUrl: './book-view-admin.component.html'
})
export class BookViewAdminComponent implements OnInit {
    ...
    constructor(private service: BookAdminService, private categoryService: CategoryAdminService, private copyService: CopyAdminService, private authorService: AuthorAdminService){
