...
@Component({
  selector: 'app-reservation-state-view-admin',
  templateUrl: './reservation-state-view-admin.component.html'
})
export class ReservationStateViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReservationStateAdminService){
