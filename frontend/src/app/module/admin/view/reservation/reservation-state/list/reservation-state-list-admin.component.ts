...
@Component({
    selector: 'app-reservation-state-list-admin',
    templateUrl: './reservation-state-list-admin.component.html'
})
export class ReservationStateListAdminComponent implements OnInit {

    protected fileName = 'ReservationState';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ReservationStateDto>();
    ...
    public async edit(dto: ReservationStateDto) {
    ...
    public async view(dto: ReservationStateDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ReservationStateDto) {
    ...
    public async duplicate(dto: ReservationStateDto) {
    ...
    public exportPdf(dto: ReservationStateDto): void {
    ...
    public initDuplicate(res: ReservationStateDto) {
    }
    ...
    get selections(): Array<ReservationStateDto> {
        return this.service.selections;
    }

    set selections(value: Array<ReservationStateDto>) {
