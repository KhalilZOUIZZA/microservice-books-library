...
@Component({
  selector: 'app-reservation-item-edit-admin',
  templateUrl: './reservation-item-edit-admin.component.html'
})
export class ReservationItemEditAdminComponent implements OnInit {
