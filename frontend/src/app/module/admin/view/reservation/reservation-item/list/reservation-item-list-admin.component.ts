...
@Component({
    selector: 'app-reservation-item-list-admin',
    templateUrl: './reservation-item-list-admin.component.html'
})
export class ReservationItemListAdminComponent implements OnInit {

    protected fileName = 'ReservationItem';
    ...
    constructor(private service: ReservationItemAdminService, private copyService: CopyAdminService, private reservationService: ReservationAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ReservationItemDto>();
    ...
    public async edit(dto: ReservationItemDto) {
    ...
    public async view(dto: ReservationItemDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ReservationItemDto) {
    ...
    public async duplicate(dto: ReservationItemDto) {
    ...
    public exportPdf(dto: ReservationItemDto): void {
    ...
    public initCol() {
        this.cols = [
            { field: 'copy?.serialNumber', header: 'Copy' },
            { field: 'reservation?.code', header: 'Reservation' },
            { field: 'returnDate', header: 'Return date' },
        ];
    }


    public async loadCopy() {
        this.copyService.findAllOptimized().subscribe(copys => this.copys = copys, error => console.log(error))
    }
    public async loadReservation() {
        this.reservationService.findAllOptimized().subscribe(reservations => this.reservations = reservations, error => console.log(error))
    }


    public initDuplicate(res: ReservationItemDto) {
    }
            ...
            this.service.findByCriteria(this.criteria).subscribe(
                (allItems) => {
                    this.exportData = allItems.map(e => ({
                        'Copy': e.copy?.serialNumber,
                        'Reservation': e.reservation?.code,
                    ...
                    resolve(); // Resolve the promise when data preparation is complete
                },
                (error) => {
    ...
    get selections(): Array<ReservationItemDto> {
        return this.service.selections;
    }

    set selections(value: Array<ReservationItemDto>) {
