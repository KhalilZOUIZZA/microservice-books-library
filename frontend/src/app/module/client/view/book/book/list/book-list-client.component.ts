...
import {ReservationClientService} from "../../../../../../shared/service/client/reservation/ReservationClient.service";
...
export class BookListClientComponent implements OnInit {
    ...
    constructor(private serviceRes: ReservationClientService , private service: BookClientService  , private categoryService: CategoryClientService, private copyService: CopyClientService, private authorService: AuthorClientService, @Inject(PLATFORM_ID) private platformId?) {
...
//add thiis
    ...
    // get item1(): ReservationDto {
    //     return this.serviceRes.item;
    // }
    //
    // set item1(value: ReservationDto) {
    //     this.serviceRes.item = value;
    // }
    // public async openCreate1() {
    //     this.item1 = new ReservationDto();
    //     this.createDialog = true;
    // }
    //
    //
    public createReservationDialog: boolean = false;
    public reservation: ReservationDto = new ReservationDto();

    public openCreateReservation(book: BookDto): void {
        this.reservation = new ReservationDto();
        this.reservation.book = book;
        this.createDialog1  = true;
    }

    public closeReservationDialog(): void {
        this.createDialog1  = false;
    }
    get createDialog1(): boolean {
        return this.serviceRes.createDialog;
    }

    set createDialog1(value: boolean) {
        this.serviceRes.createDialog = value;
    }
    get createActionIsValid1(): boolean {
        return this.serviceRes.createActionIsValid;
    }

    set createActionIsValid1(value: boolean) {
        this.serviceRes.createActionIsValid = value;
    }
...
// add
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            //'Category': this.criteria.category?.label ? this.criteria.category?.label : environment.emptyForExport ,
            //'Author': this.criteria.author?.fullName ? this.criteria.author?.fullName : environment.emptyForExport ,
