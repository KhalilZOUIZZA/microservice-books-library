...
@Component({
  selector: 'app-reservation-create-client',
  templateUrl: './reservation-create-client.component.html'
})
export class ReservationCreateClientComponent  implements OnInit {
   ...
   private _validReservationTheoreticalReturnDate = true;
    ...
    ngOnInit(): void {
        ...
        if (this.clients && this.clients.length > 0) {
            this.item.client = this.clients[0]; // Set the first option as default
          }
    }
