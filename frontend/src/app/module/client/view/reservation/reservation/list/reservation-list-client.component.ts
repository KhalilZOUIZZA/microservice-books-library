...
// add
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            //'Reservation state': this.criteria.reservationState?.label ? this.criteria.reservationState?.label : environment.emptyForExport ,
            //'Client': this.criteria.client?.email ? this.criteria.client?.email : environment.emptyForExport ,
            }];
			}
