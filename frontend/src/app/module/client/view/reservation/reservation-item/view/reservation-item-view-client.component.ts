...
@Component({
  selector: 'app-reservation-item-view-client',
  templateUrl: './reservation-item-view-client.component.html'
})
export class ReservationItemViewClientComponent implements OnInit {
    ...
    constructor(private service: ReservationItemClientService, private copyService: CopyClientService, private reservationService: ReservationClientService){
