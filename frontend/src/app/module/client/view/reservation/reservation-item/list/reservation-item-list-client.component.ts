...
@Component({
  selector: 'app-reservation-item-list-client',
  templateUrl: './reservation-item-list-client.component.html'
})
export class ReservationItemListClientComponent implements OnInit {
...
// add
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            this.criteriaData = [{
            //'Copy': this.criteria.copy?.serialNumber ? this.criteria.copy?.serialNumber : environment.emptyForExport ,
            //'Reservation': this.criteria.reservation?.code ? this.criteria.reservation?.code : environment.emptyForExport ,
