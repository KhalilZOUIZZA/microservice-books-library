...
import {ClientCriteria} from 'src/app/shared/criteria/reservation/ClientCriteria.model';
...
export class ClientEditClientComponent implements OnInit {
    ...
    constructor(private service: ClientClientService , @Inject(PLATFORM_ID) private platformId?) {
