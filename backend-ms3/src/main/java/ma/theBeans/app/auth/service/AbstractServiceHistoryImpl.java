...
import ma.theBeans.app.auth.dto.AuditEntityDto;
import ma.theBeans.app.auth.exception.EntityNotFoundException;
import ma.theBeans.app.auth.bean.BaseEntity;
import ma.theBeans.app.auth.history.HistCriteria;
import ma.theBeans.app.auth.repository.AbstractHistoryRepository;
import ma.theBeans.app.auth.security.bean.User;
import ma.theBeans.app.auth.security.service.facade.UserService;
import ma.theBeans.app.auth.specification.AbstractHistorySpecification;
import ma.theBeans.app.auth.util.RefelexivityUtil;
