...
import ma.theBeans.app.auth.security.dao.facade.core.UserDao;
import ma.theBeans.app.auth.security.dao.specification.core.UserSpecification;
...
import ma.theBeans.app.auth.util.ListUtil;
import ma.theBeans.app.auth.util.StringUtil;
...
*/
    ...
    public ClientDto findByUsernameDto(String username) {
        if (username == null) {
            return null;
        }

        // Fetch the User entity from the DAO
        ...
        clientDto.setAccountNonExpired(user.isAccountNonExpired());
        clientDto.setAccountNonLocked(user.isAccountNonLocked());
