package ma.theBeans.app.auth.controller;

import jakarta.servlet.http.HttpServletRequest;
import ma.theBeans.app.auth.bean.BaseEntity;
import ma.theBeans.app.auth.converter.AbstractConverter;
import ma.theBeans.app.auth.criteria.BaseCriteria;
import ma.theBeans.app.auth.dto.BaseDto;
import ma.theBeans.app.auth.dto.FileTempDto;
import ma.theBeans.app.auth.exception.BusinessRuleException;
import ma.theBeans.app.auth.exception.GlobalException;
import ma.theBeans.app.auth.export.ExportModel;
import ma.theBeans.app.auth.service.IService;
import ma.theBeans.app.auth.util.*;
