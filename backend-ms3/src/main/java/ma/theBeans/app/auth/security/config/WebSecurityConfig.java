package ma.theBeans.app.auth.security.config;

import ma.theBeans.app.auth.security.common.AuthoritiesConstants;
import ma.theBeans.app.auth.security.jwt.AuthEntryPointJwt;
import ma.theBeans.app.auth.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/send-reset-code").permitAll()
