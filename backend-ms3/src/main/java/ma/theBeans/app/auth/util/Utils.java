...
import ma.theBeans.app.auth.audit.AuditEntity;
import ma.theBeans.app.auth.audit.Log;
import ma.theBeans.app.auth.bean.BusinessObject;
import ma.theBeans.app.auth.bean.EnumBean;
