function fn() {
    ...
    config.reservationItemUrl = config.adminUri + 'reservationItem/';
    config.reservationUrl = config.adminUri + 'reservation/';
    config.reservationStateUrl = config.adminUri + 'reservationState/';
    config.clientUrl = config.adminUri + 'client/';
    config.copyUrl = config.adminUri + 'copy/';
    config.bookUrl = config.adminUri + 'book/';
    config.categoryUrl = config.adminUri + 'category/';
    config.authorUrl = config.adminUri + 'author/';
