...
import ma.theBeans.app.ws.facade.admin.reservation.ReservationItemRestAdmin;
...
public class ReservationItemRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private ReservationItemAdminServiceImpl service;
    @Mock
    private ReservationItemConverter converter;

    @InjectMocks
    private ReservationItemRestAdmin controller;
