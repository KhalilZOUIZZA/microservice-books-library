package ma.theBeans.app.unit.service.impl.client.reservation;
...
import ma.theBeans.app.service.impl.client.reservation.ReservationStateClientServiceImpl;
...
@SpringBootTest
class ReservationStateClientServiceImplTest {

    @Mock
    private ReservationStateDao repository;
    private AutoCloseable autoCloseable;
    private ReservationStateClientServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReservationStateClientServiceImpl(repository);
    }
