...
import ma.theBeans.app.thePackage.security.bean.*;
...
public class AppApplication {
    ...
    private void createReservationState(){
            ReservationState itemSuccess = new ReservationState();
            itemSuccess.setStyle("success");
            itemSuccess.setLabel("Completed");
            itemSuccess.setCode("Completed");
            reservationStateService.create(itemSuccess);
            ReservationState itemPrimary = new ReservationState();
            itemPrimary.setStyle("primary");
            itemPrimary.setLabel("InProgress");
            itemPrimary.setCode("InProgress");
            reservationStateService.create(itemPrimary);
            ReservationState itemDanger = new ReservationState();
            itemDanger.setStyle("danger");
            itemDanger.setLabel("Overdue");
            itemDanger.setCode("Overdue");
            reservationStateService.create(itemDanger);
            ReservationState itemWarning = new ReservationState();
            itemWarning.setStyle("warning");
            itemWarning.setLabel("Pending");
            itemWarning.setCode("Pending");
            reservationStateService.create(itemWarning);
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        modelPermissions.add(new ModelPermission("ReservationItem"));
        modelPermissions.add(new ModelPermission("Reservation"));
        modelPermissions.add(new ModelPermission("ReservationState"));
    ...
    @Autowired
    ReservationStateAdminService reservationStateService;
}
