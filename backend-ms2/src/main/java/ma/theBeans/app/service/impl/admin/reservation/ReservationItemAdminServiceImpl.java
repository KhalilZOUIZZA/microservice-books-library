...
@Service
public class ReservationItemAdminServiceImpl implements ReservationItemAdminService {
    ...
    public void findOrSaveAssociatedObject(ReservationItem t){
        if( t != null) {
            t.setCopy(copyService.findOrSave(t.getCopy()));
    ...
    public ReservationItemAdminServiceImpl(ReservationItemDao dao) {
        this.dao = dao;
    }
