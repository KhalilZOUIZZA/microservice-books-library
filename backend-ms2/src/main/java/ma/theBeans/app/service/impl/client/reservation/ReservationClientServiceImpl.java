...
public class ReservationClientServiceImpl implements ReservationClientService {
    ...
    @Autowired
    private ReservationStateClientService reservationStateService ;
    @Autowired
    private ReservationItemClientService reservationItemService ;
    @Autowired
    private CopyClientService copyService ;
    @Autowired
    private ClientClientService clientService ;

    public ReservationClientServiceImpl(ReservationDao dao) {
        this.dao = dao;
    }
