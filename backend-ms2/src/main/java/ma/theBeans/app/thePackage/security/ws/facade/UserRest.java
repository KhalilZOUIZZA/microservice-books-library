...
import ma.theBeans.app.thePackage.controller.AbstractController;
import ma.theBeans.app.thePackage.dto.FileTempDto;
...
import ma.theBeans.app.thePackage.security.payload.request.ChangePasswordRequest;
...
public class UserRest  extends AbstractController<User, UserDto, UserCriteria, UserService, UserConverter> {
    ...
    public ResponseEntity<UserDto> update(@RequestBody UserDto userDto) {
        User updatedUser = service.update(converter.toItem(userDto));
        UserDto updatedUserDto = converter.toDto(updatedUser);
