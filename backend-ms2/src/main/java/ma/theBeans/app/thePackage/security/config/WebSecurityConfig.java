package ma.theBeans.app.thePackage.security.config;

import ma.theBeans.app.thePackage.security.common.AuthoritiesConstants;
import ma.theBeans.app.thePackage.security.jwt.AuthEntryPointJwt;
import ma.theBeans.app.thePackage.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/admin/book/").permitAll() // Allow GET requests to this endpoint
                                .requestMatchers(HttpMethod.GET, "/api/client/book/find-paginated-by-criteria").permitAll() // Allow GET requests to this endpoint
                                ...
                                .requestMatchers("/api/client/book/find-paginated-by-criteria").permitAll()
