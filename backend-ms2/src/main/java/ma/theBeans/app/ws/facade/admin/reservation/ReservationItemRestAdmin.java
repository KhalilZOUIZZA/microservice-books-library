...
@RestController
@RequestMapping("/api/admin/reservationItem/")
public class ReservationItemRestAdmin {
   ...
   public ReservationItemRestAdmin(ReservationItemAdminService service, ReservationItemConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReservationItemAdminService service;
